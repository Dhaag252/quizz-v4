...
let quizAnswers = [];  // De array om antwoorden van de gebruiker op te slaan
...
startBtn.addEventListener('click', () => {
  ...
  quizAnswers = []; // Reset antwoordenlijst bij nieuwe start
  loadQuestion();
});
...
function loadQuestion() {
  ...
  // Sla vraag en correcte antwoord op in `quizAnswers`
  quizAnswers.push({
      question: currentQuiz.question,
      correct: currentQuiz.correct,
      userAnswer: null  // Sla het gebruikersantwoord in voor deze vraag
  });
...
function checkAnswer() {
  ...
  if (selectedOption) {
      ...
      // Bewaar het gebruikersantwoord in `quizAnswers`
      quizAnswers[currentQuestion].userAnswer = answer;
